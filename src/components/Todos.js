...
const Todos = () => {
  ...
  const getLocalStorage = () =>
    JSON.parse(localStorage.getItem('myTodosList')) || initialTodos
  ...
  useEffect(() => {
    // enregistre dans localStorage quand todos change
    localStorage.setItem('myTodosList', JSON.stringify(todos))
  }, [todos])
